...
class StartPage(tk.Frame):
    ...
    def _create_treeview(self):
        self.dataCols = ["f.id_fato", "s.id_sample", "s.name", "s.path", "s.extension", "s.disk", "id_tag", "tag"]
        ...
        #ysb.grid(in_=self, row=10, column=1, columnspan=6)
        #xsb.grid(in_=self, row=11, column=2, columnspan=6)
        self.tree.pack()
